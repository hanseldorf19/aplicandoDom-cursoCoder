...
function detGenPelis() {
    ...
    console.log(`Gracias estos son tus 3 generos preferidos ${tusGenPelis.join(', ')}`)
    menuGenPelis();
}
...
class Pelicula{
    ...
    //funciones
    mostrar() {
        console.log('Nombre: ' + this.nombre + ' Descripción corta: + ' + this.descripcion_corta + 'Año: '+ 
        this.anio + 'Protagonistas: ' + this.protagonistas + 'Premios: ' + this.premios );
    }
}

// Objetos a sugerir ()

// Peliculas, Directores, Actores
